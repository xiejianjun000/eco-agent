...
_TDOC_DOC_MCP_URL="https://docs.qq.com/api/v6/doc/mcp"
_TDOC_DOC_SERVICE_NAME="doc-mcp"
_TDOC_SHEET_MCP_URL="https://docs.qq.com/api/v6/sheet/mcp"
...
# 同时注册 tencent-docs / slide-mcp / doc-mcp / sheet-mcp 四个服务，使用相同的 Token
_tdoc_save_token() {
    # 添加 MCP 配置
    echo "🔧 配置 mcporter..."
