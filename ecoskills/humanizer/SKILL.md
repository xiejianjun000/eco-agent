---
name: humanizer
description: 去除 AI 写作痕迹的文本改写技能：改写听起来像 AI 的文本，使其读起来自然如人类所写而不改变原意；适用于编辑/审阅散文时存在夸大措辞、销售话术、空泛来源、重复结构、AI 套话、被动语态、废话填充或聊天机器人痕迹的场景。基于 Wikipedia 的 Signs of AI writing。
---
