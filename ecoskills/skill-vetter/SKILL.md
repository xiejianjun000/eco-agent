---
name: skill-vetter
description: 安装新技能/新插件前安全检查、审查脚本风险、审计技能权限时使用。Security-first vetting for OpenClaw skills. Use before installing any skill from ClawHub, GitHub, or other sources. Checks for red flags, permission scope, and suspicious patterns.
---
# Skill Vetter
