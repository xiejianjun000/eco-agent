...
from server.api.chat import (_cut_at_boundary, _enforce_concise,
                              _normalize_markdown, _sanitize_thinking)
...
def test_sanitize_thinking_strips_rule_recital():
    ...
    text = ("用户只是打了个招呼。根据规则19和身份说明，自我介绍类提问用一句话身份"
